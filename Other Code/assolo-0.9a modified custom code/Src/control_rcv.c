...
struct sockaddr_in receiver;
  ...
  /*custom code here - srinivas prasad gumdelli*/
  bzero((char *)&receiver, sizeof (receiver));
  //declare an address to bind the port to - Srinivas Prasad Gumdelli
  receiver.sin_family = AF_INET;
  receiver.sin_port = htons(33234);
  //bind the socket here to a particular port and continue....this is the important part! - Srinivas Prasad Gumdelli
  if (bind (soudp, (struct sockaddr *) &receiver, sizeof(receiver)) < 0) {
  perror ("pathchirp_rcv_tcp: bind");
  exit (1);
  }
